...
import org.github.ewt45.winemulator.emu.manager.TerminalManager
...
class MainEmuActivity : MainActivity() {
    ...
    val terminalView: TerminalView by lazy { createTerminalView() }
...
//        }
    ...
    override fun onDestroy() {
        ...
        terminalManager.service?.unsetTerminalSessionClientA()
        unbindService(terminalManager.serviceConnection)
    }
...
//                .setContentIntent(PendingIntent.getActivity(this, 0, Intent.makeMainActivity(componentName), PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE))
    ...
    private fun createTerminalView():TerminalView {
        return TerminalView(this, null).apply {
            setTerminalViewClient(terminalManager.viewClient)
